...
public class DayNightSystem2D : MonoBehaviour
{
    ...
    public float DayNightTime = 0;

    private float MaxDayNightTime;
    ...
    void Start()
    {
        ...
        MaxDayNightTime = cycleMaxTime * 5; // start global color at sunrise
        DayNightTime = cycleCurrentTime;
    }
